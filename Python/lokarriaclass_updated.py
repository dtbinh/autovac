...
Authors: Shanmuganathan Sabarisathasivam
...
FILENAME = 'Path-around-table.json'

#==============================================================================
#goToPoint() constants
BEARING_THRESHOLD = 0.1
DISTANCE_THRESHOLD = 0.1
GOTOPOINT_ANG_SPEED = 0.7
GOTOPOINT_LIN_SPEED = 0.7
DISTANCE_BETWEEN_CARROT_POINTS=0.25
...
####    py=list()
####    for i in range(0,n):
####        px=r1.path[i]['Pose']['Position']['X']
####        py=r1.path[i]['Pose']['Position']['Y']
####        print px,py
##
